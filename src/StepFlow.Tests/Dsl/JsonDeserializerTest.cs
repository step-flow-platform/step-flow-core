...
//
//         StepDefinition(model.Steps[0], "SimpleStep", null, null);
//
//         StepDefinition(model.Steps[1], "StepWithInput", new List<KeyValuePair<string, object>>
//             {
...
//             null);
//
//         StepDefinition(model.Steps[2], "StepWithInputAndOutput", new List<KeyValuePair<string, object>>
//             {
...
//         Assert.AreEqual(3, model.Steps.Count);
//
//         StepDefinition(model.Steps[0], "step1", null, null);
//
//         WorkflowBranchModel? step2 = model.Steps[1] as WorkflowBranchModel;
//         Assert.IsNotNull(step2);
//         Assert.AreEqual("+IfDefinition", step2.Name);
//         Assert.AreEqual("data.Result > 5", step2.Condition);
//         Assert.AreEqual(3, step2.Steps.Count);
//
//         StepDefinition(model.Steps[2], "step3", null, null);
//
//         StepDefinition(step2.Steps[0], "step11", null, null);
//
//         StepDefinition(step2.Steps[1], "step12", null, null);
//
//         WorkflowBranchModel? step13 = step2.Steps[2] as WorkflowBranchModel;
//         Assert.IsNotNull(step13);
//         Assert.AreEqual("+IfDefinition", step13.Name);
//         Assert.AreEqual("data.SomeFlag", step13.Condition);
//         Assert.AreEqual(2, step13.Steps.Count);
//
//         StepDefinition(step13.Steps[0], "step111", null, null);
//
//         StepDefinition(step13.Steps[1], "step112", null, null);
//     }
//
//     private void StepDefinition(WorkflowNodeModel node, string expectedName,
